...
# global = 1- identifikator pouziva globalni prommnene
global_variable = 1

PI = 3.14
city = "Opava"
# hilda@sspu-opava.cz = 'Hilda Dokonalá' - neda se pouzit protoze v pythonu jsou zakazane znaky @,.-
password2 = 'TajneHeslo'
# 007agent = 'James Bond' - je spatne jelikož nesmi prommena zacinat cislem
